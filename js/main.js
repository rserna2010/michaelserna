(function($) {
  ...
  function initVideoModal() {
    ...
    $('.work-detail a').on('click', function(e) {
      e.preventDefault();
    ...
    $('#contact-form').on('submit', function(event) {
      ...
      if (isValidForm()) {
        $.ajax({
          ...
          .done(function(e) {
            console.log(e);
            var message = $('#contact-form').data('success-text') || "Thanks for the note. I'll get back to you shortly!";
          ...
          .fail(function() {
            var message = $('#contact-form').data('error-text') || "Oops! There was an error. That's not supposed to happen...";
            var errorTemplate = '<div role="alert" class="alert alert-danger alert-outline">' + message + '</div>';
            $('#contact-form .alert').hide();
            $(errorTemplate).insertBefore($('#contact-form button'));
          })
      } else {
        var message = $('#contact-form').data('error-text') || 'Please fill in the required fields.';
        var errorTemplate = '<div role="alert" class="alert alert-danger alert-outline">' + message + '</div>';
        $('#contact-form .alert').hide();
        $(errorTemplate).insertBefore($('#contact-form button'));
      }
